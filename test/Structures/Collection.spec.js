...
import {email, string} from '../../src/Validation/Rules.js'
...
describe('Collection', () => {
    ...
    describe('emit', () => {
        ...
        it('should emit all events even if some are rejected', () => {
            ...
            expect(c.emit('test')).to.equal(false);
    ...
    describe('constructor', () => {
        ...
        it('should be okay with an undefined or null options object', () => {
            let c1 = new Collection([], undefined);
            let c2 = new Collection([], null);
            expect(c1.loading).to.equal(false);
            expect(c2.loading).to.equal(false);
        })
    })
    ...
    describe('remove', () => {
        ...
        it('should not attempt to remove if the collection does not contain the model', () => {
            let c = new Collection();
            let m1 = c.add({id: 1});
            let m2 = c.add({id: 2});
    ...
    describe('delete', () => {
        ...
        it('should skip when there are no effective models to delete', function(done) {
            let c = new class extends Collection {
                routes() { return {delete: '/delete'}}
            }
            ...
            m1.on('delete', (e) => {
                expect(e.target).to.equal(m1);
                expect(e.collection).to.equal(c);
                return false;
            });

            m2.on('delete', (e) => {
                expect(e.target).to.equal(m2);
                expect(e.collection).to.equal(c);
                return false;
            });
        ...
        it('should skip when there are no models to delete', function(done) {
            let c = new class extends Collection {
                routes() { return {delete: '/delete'}}
            }
        ...
        it('should emit "failure" event on failure', function(done) {
            ...
            c.on('delete.failure', (error, response) => {
        ...
        it('should emit "always" event on failure', function(done) {
            ...
            c.on('delete.always', (error, response) => {
                expect(error).to.not.be.null;
                expect(response).to.not.be.null;
                done();
            });
        ...
        it('should remove all models on delete', function(done) {
            let c = new class extends Collection {
                routes() { return {delete: '/delete'}}
            }
    ...
    describe('save', () => {
        ...
        it('should not save models that return false on "save" event', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
            ...
            moxios.withMock(() => {
                ...
                moxios.wait(() => {
                    let request = moxios.requests.mostRecent();
                    expect(request.config.data).to.equal('[{"a":2}]');
                    done();
                })
            })
        })

        it('should not attempt to save if no models qualify', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should not attempt to save if a "save" event returns false', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should fail when saving models but received an empty array', (done) => {
            ...
            moxios.withMock(() => {
                c.save((err, res) => {
                    expect(err.message).to.equal('Expected the same number of models in the response');
                    done();
                });
        ...
        it('should fail if response data is not resolved to an array', (done) => {
            ...
            moxios.withMock(() => {
                c.save((err, res) => {
                    expect(err.message).to.equal('Response data must be an array or empty');
                    done();
                });
        ...
        it('should report unexpected state if we mess with things during save', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
            ...
            moxios.withMock(() => {
                c.save((err, res) => {
                    expect(err.message).to.equal('Not allowed to overwrite model identifier');
                    done();
                });
        ...
        it('should emit update and save events on all models being updated', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
            ...
            m1.on('update', (e) => { e.target.flag = true; });
            m2.on('update', (e) => { e.target.flag = true; });
        ...
        it('should emit create events on all models being created', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
            ...
            m1.on('create', (e) => { e.target.flag = true; });
            m2.on('create', (e) => { e.target.flag = true; });
        ...
        it('should emit save success event on success', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should emit save always event on success', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should call success handler on success', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should call always handler on success', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should call default handler on success', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should call default handler on fatal failure', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should call default handler on validation failure', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should fail if validation error response data is not resolved to an array', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should emit save failure event on fatal save failure', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should emit save always event on fatal failure', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should emit save always event on validation failure', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should call failure handler on failure', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
        ...
        it('should call always handler on failure', (done) => {
            let c = new class extends Collection {
                routes() { return {save: '/save'}}
            }
    ...
    describe('fetch', () => {
        ...
        it('should not fetch if fetch event handler returns false', (done) => {
            let c = new class extends Collection {
                routes() { return {fetch: '/fetch'}}
            }

            c.on('fetch', () => { return false; })
        ...
        it('should not fetch if paginated and on last page', (done) => {
            let c = new class extends Collection {
                routes() { return {fetch: '/fetch'}}
            }
            ...
            moxios.withMock(() => {
                ...
                moxios.wait(() => {
                    ...
                    expect(request.config.params).to.deep.equal({page: 1});
        ...
        it('should fatal to false on non-paginated success', (done) => {
            let c = new class extends Collection {
                routes() { return {fetch: '/fetch'}}
            }
        ...
        it('should fatal to false on paginated success', (done) => {
            let c = new class extends Collection {
                routes() { return {fetch: '/fetch'}}
            }
        ...
        it('should fail if response is missing', (done) => {
            ...
            moxios.withMock(() => {
                c.fetch((err, res) => {
                    expect(err.message).to.equal('Expected an array of models in fetch response');
                    done();
                });
